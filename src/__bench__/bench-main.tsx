    ...
    ({ selected, item, dispatch }) =>
        jsx(
            ...
            jsx(
                ...
                jsx(
                    'a',
                    { onClick: useMemo(() => () => dispatch({ type: 'SELECT', id: item.id }), []) },
                    item.label
                )
            ),
            jsx(
                ...
                jsx(
                    'a',
                    { onClick: useMemo(() => () => dispatch({ type: 'REMOVE', id: item.id }), []) },
...
const Button = ({ id, cb, title }: any) =>
    jsx(
        ...
        jsx(
            'button',
            { type: 'button', className: 'btn btn-primary btn-block', id: id, onClick: cb },
            title
        )
    );
    ...
    ({ dispatch }) =>
        jsx(
            ...
            jsx(
                'div',
                { className: 'row' },
                jsx('div', { className: 'col-md-6' }, jsx('h1', null, 'React Hooks keyed')),
                jsx(
                    'div',
                    { className: 'col-md-6' },
                    jsx(
...
createRoot(document.getElementById('main') as any, jsx(Main, null));
