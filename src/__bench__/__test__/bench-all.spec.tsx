/** @jsx jsx */
import { Dispatch, createRoot, jsx, memo, useMemo, useReducer } from '../../index';
...
describe('bench-all', () => {
    it('runs bench-all', () => {
        ...
        type BenchDispatch = Dispatch<Action>;
        ...
        console.time('bench-1k');
        createRoot(void 0 as any, <BenchMain dispatchRef={dispatchRef} />);
