...
function commitRoot() {
    ...
    if (WipRoot) {
        ...
        while (nextFiberToCommit) {
            ...
            nextFiberToCommit = nextFiberWithFilter(nextFiberToCommit, WipRoot, placedOrNonSkipped, !!(nextFiberToCommit.flags & Skipped)
...
function createFiber(element, parent, move) {
