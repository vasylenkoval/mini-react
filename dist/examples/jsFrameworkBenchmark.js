...
const Row = memo(({ selected, item, dispatch }) => (jsx("tr", { className: selected ? 'danger' : '' },
    ...
    jsx("td", { className: "col-md-6" }))), (prevProps, nextProps) => prevProps.selected === nextProps.selected && prevProps.item === nextProps.item);
...
createRoot(document.getElementById('root'), jsx(Main, null));
